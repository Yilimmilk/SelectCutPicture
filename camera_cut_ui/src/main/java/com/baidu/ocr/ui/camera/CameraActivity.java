            ...
            new Thread() {
                ...
                public void run() {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        ...
                        cameraUri = FileProvider.getUriForFile(CameraActivity.this, authority, outputFile);
                    } else {
                        cameraUri = Uri.fromFile(outputFile);
                    }
                    //Uri cameraUri =  FileProvider.getUriForFile(CameraActivity.this, "moe.moz.pickpicture.provider", outputFile);
                    intent.putExtra(CameraActivity.KEY_CONTENT_TYPE, contentType);
                    intent.setDataAndType(cameraUri,"image/*");
                    Log.d("CameraActivity将要返回:",intent.getData()+"");
